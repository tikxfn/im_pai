...
class CityList extends StatefulWidget {
  ...
  static const String path = 'application/city';
...
class _CityListState extends State<CityList> {
  ...
  updateUserSelect() async {
    ...
    try {
      ...
      await api.circleUpdateCircleOwn(
        V1UpdateCircleMemberSetArgs(
          circleId: circleId,
          areaCode: V1UpdateCircleMemberSetArgsValue(value: areaCode),
        ),
      );
      if (!mounted) return;

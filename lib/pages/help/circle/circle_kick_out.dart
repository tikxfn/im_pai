...
class CircleKickOut extends StatefulWidget {
  const CircleKickOut({super.key});

  static const String path = 'circle/circle_kick_out';

  @override
  State<StatefulWidget> createState() {
    return _CircleKickOutState();
  }
}

class _CircleKickOutState extends State<CircleKickOut> {
  int limit = 50;
  String keywords = '';
  ...
  delete() async {
    confirm(
      ...
      onEnter: () async {
        ...
        loading();
        try {
          await api.circleExitCircleMember(
              V1ExitCircleMemberArgs(circleId: circleId, userIds: userIds));
          // if (res == null) return;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        // actions: [
        //   TextButton(
        //       onPressed: activeIds.isEmpty ? null : delete,
        //       child: Text(
        //         '删除'.tr(),
        //         style: TextStyle(
        //           fontSize: 15,

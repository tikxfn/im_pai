...
class GroupCleanUser extends StatefulWidget {
  const GroupCleanUser({super.key});

  static const path = 'group/clean_user';

  @override
  State<GroupCleanUser> createState() => _GroupCleanUserState();
}

class _GroupCleanUserState extends State<GroupCleanUser> {
  String roomId = '';
  String selectDays = '';
  ...
  save() async {
    ...
    try {
      ...
      await api.roomClearMember(args);
      tip('操作成功'.tr());

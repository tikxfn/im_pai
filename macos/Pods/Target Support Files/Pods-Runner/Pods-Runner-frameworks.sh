...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/desktop_multi_window/desktop_multi_window.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/fc_native_video_thumbnail/fc_native_video_thumbnail.framework"
